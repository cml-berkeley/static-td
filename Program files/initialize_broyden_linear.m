function initialize_broyden_linear(x,x_1,x_2)
...
fclose(fid_8);
%%
h_next_in = (x-x_1)/(x_2-x_1)*(h_in_2-h_in_1) + h_in_1;
disk_temp = (x-x_1)/(x_2-x_1)*(disk_temp_2-disk_temp_1) + disk_temp_1;
slider_temp = (x-x_1)/(x_2-x_1)*(slider_temp_2-slider_temp_1) + slider_temp_1;
...
fid_3 = fopen('disk_temp_initial.dat', 'w');
fprintf(fid_3,'%15.11f\t%15.11f\t%15.11f\n',disk_temp');
fclose(fid_3);

fid_4 = fopen('slider_temp_initial.dat', 'w');
fprintf(fid_4,'%15.11f\t%15.11f\t%15.11f\n',slider_temp');
fclose(fid_4);
